  ...
  return (
    <div id="experience" className="w-full">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        <h2 className="py-4 max-w-lg"> ◐ Implemented front-end technical solutions to meet project requirements for creation of 5 new web pages.
        ...
        ◐ Created Landing pages using HTML & CSS</h2>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          {experiences.map(({ id, title, src }) => (
            ...
            >
              <Image src={src} width="200px" height="73px" alt="randomness" />
