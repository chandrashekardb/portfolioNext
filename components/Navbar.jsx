...
const Navbar = () => {
  ...
  return (
    <div className={`w-full h-20 z-10 fixed bg-blue-50 text-black duration-300 ease-in shadow ${pageScroll && "bg-blue-50 text-[#000]"}`}>
        <div className='flex justify-between items-center w-full h-full max-w-screen-xl mx-auto p-4'>
            ...
            <div>
              ...
              {!navigation && (<div className='md:hidden cursor-pointer' onClick={()=>setNavigation(true)}>
                  <FaBars size={30}/>
                  </div>)}
          ...
          <div className={navigation ?'fixed left-0 top-0 w-4/5 h-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-10 ease-in duration-500': 'fixed top-0 left-[-100%] p-10 h-full ease-in duration-500'}>
                  <div>
                    <div className='flex w-full items-center justify-between'>
                      <Link href='/#home'>
                        <h2 onClick={()=>setNavigation(false)} className='text-3xl font-bold uppercase underline underline-offset-2 tracking-wider cursor-pointer'>chandrashekar</h2>
                      </Link>
