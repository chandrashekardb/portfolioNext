...
const HomePage = () => {
  return (
    <div id="home" className=" h-screen w-full text-center bg-gray-100">
      <div className="max-w-screen-xl mx-auto w-full h-full pt-24 p-4 flex flex-col justify-around items-center">
        ...
        <p className="text-gray-600 text-xl max-w-sm mx-auto">
           I have a 6 monts of experience building and desgining software. Currently, I love to work on web application using techonologies like React, Tailwind, Next Js and Node JS</p>
